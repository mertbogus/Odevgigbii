...
<body>
<div class="header" style="overflow: hidden; height:50px; width:auto;"><img
            src="<?php echo base_url('public/front/image/logo.png'); ?>" class="image" alt="logo"  style="height:30px; width:50px;"/></div>
<div class="container">
